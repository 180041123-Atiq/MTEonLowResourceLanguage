...
def trainOpenChatTokenizer(dataPath):
  tokenizer = ByteLevelBPETokenizer()
  tokenizer.train(
      files=dataPath,
      vocab_size=1000,  # You can increase this
  ...
  # Load the tokenizer for the DeepSeek base model
  hf_tokenizer = AutoTokenizer.from_pretrained("openchat/openchat-3.5-1210")
